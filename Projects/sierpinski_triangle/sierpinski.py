...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	...
	if order == 0:
		...
		left_line = GLine(upper_left_x, upper_left_y, upper_left_x+length/2, upper_left_y+length*0.886)
		right_line = GLine(upper_left_x+length/2, upper_left_y+length*0.886, upper_left_x+length, upper_left_y)
		window.add(top_line)
		...
		# Bottom
		sierpinski_triangle(order-1, length/2, upper_left_x+length/4, upper_left_y+length*0.443)
